...
///
/// Library with has a document_scanner.dart which generates a shell script that allow
...
import '../src/util/util_dart.dart' show enumName;
...
///   for the flutter_charts example app in [example/lib/document_scanner.dart].
///
...
///
/// The conversion from enumerates to data and options is in [example/lib/document_scanner.dart], see 'chartTypeToShow'.
/// The conversion from enumerates to chart type is in [example/lib/document_scanner.dart] see 'requestedExampleToRun'.
  ...
  void asCommandLine() {
    ...
    for (Tuple2 tuple in combosToRun) {
      ...
      print(
          ...
          '\$2' // ' example/lib/document_scanner.dart'
          );
    }
  }
}
