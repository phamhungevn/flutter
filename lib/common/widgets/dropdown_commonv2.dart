...
class DropdownCommonV2 extends StatefulWidget {
  const DropdownCommonV2({super.key, required this.items, required this.onChanged, required this.title, required this.id});
  final List<User> items;
  final List<String> id;
  final String title;
  final Function onChanged;
  @override
  State<DropdownCommonV2> createState() => _DropdownCommonState();
}

class _DropdownCommonState extends State<DropdownCommonV2> {
  User? selectedValue;

  @override
  Widget build(BuildContext context) {
    //if (widget.items.isEmpty) widget.items.add(User());
    return
        DropdownButtonHideUnderline(
          child: DropdownButton2<User>(
            ...
            items: widget.items
                .map((User item) => DropdownMenuItem<User>(
              value: item,
              child: Text(
                item.email,
                style: const TextStyle(
...
class DropdownCommonClass extends StatefulWidget {
  const DropdownCommonClass({super.key, required this.items, required this.onChanged, required this.title});
  final List<ClassModel> items;
  final String title;
  final Function onChanged;
  @override
  State<DropdownCommonClass> createState() => _DropdownCommonClassState();
}

class _DropdownCommonClassState extends State<DropdownCommonClass> {
    ...
    return
      DropdownButtonHideUnderline(
        child: DropdownButton2<ClassModel>(
          ...
          items: widget.items
              .map((ClassModel item) => DropdownMenuItem<ClassModel>(
            value: item,
            child: Text(
              item.name,
              style: const TextStyle(
