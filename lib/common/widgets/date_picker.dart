...
import '../../AppointmentPage/utils.dart';

class GetDate extends StatefulWidget {
  const GetDate({super.key, required this.onChanged});

  final Function onChanged;

  @override
  GetDateState createState() => GetDateState();
}

class GetDateState extends State<GetDate> {
          ...
          child: Row(
            children: [
              ...
              if (clearButtonVisible)
                IconButton(
                  icon: const Icon(Icons.clear, size: 15.0),
                  visualDensity: VisualDensity.compact,
