...
class _SpeechSampleAppState extends State<SpeechSampleApp> {
  ...
  double level = 0.0;
  double minSoundLevel = -50000;//50000;
  double maxSoundLevel = 50000;//-50000;
  int numLines=0;
  int numberWords=0;
  String lastWords = '';
  String currentWords = '';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          title: const Text('ITC club: Speech to Text'),
        ),
  ...
  Future<void> startListening() async {
   ...
   //   lastError = '';
      ...
      speech.listen(
        ...
        listenFor: Duration(hours: 1, seconds: listenFor ?? 30),
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        ...
        children: <Widget>[
          const Row(children: [ Text('Language: '),],),
          Row(
            children: [
